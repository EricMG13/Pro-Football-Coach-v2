...
|---|---|
| A season is completable in 6–8 hours | `AgencyBudgetTests` is implemented and requires owner-observed duration, hardware, build, and date; owner measurement remains open |
