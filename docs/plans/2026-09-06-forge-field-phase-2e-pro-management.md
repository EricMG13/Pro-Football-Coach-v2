...
**Parallel worktree:** yes — runs beside 2C, 2D, 2F and 2I. Merge surface: `ForgeFieldBudget.swift` (additive) and this family's five view files only. Roadmap §Running phases as parallel worktree sessions.
