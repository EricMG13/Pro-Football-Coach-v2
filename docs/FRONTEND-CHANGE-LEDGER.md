...
| E19 | **TODO** | `career` has no home in Forge Field's five families. The sheets batch it with the league and draw Opportunities, Stakeholders and Promotion decision there but never say so. `04` section 6.1f records it open. Answer before the League, career and entry batch. | `04` section 6.1f |
