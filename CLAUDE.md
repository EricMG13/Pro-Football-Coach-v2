...
This project is indexed by GitNexus as **Pro-Football-Coach-v2** (21527 symbols, 96496 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
